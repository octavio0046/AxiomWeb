...
import { Sale, SaleSearchField } from '../../core/models/api.models';
...
export class Sales implements OnInit, OnDestroy {
  ...
  protected readonly searchField = signal<SaleSearchField>('all');
  protected readonly searchText = signal('');

  protected readonly searchFields: { value: SaleSearchField; label: string }[] = [
    { value: 'all', label: 'Todos los campos' },
    { value: 'sale_number', label: 'Folio' },
  ...
  onSearchFieldChange(value: string): void {
    this.searchField.set((value as SaleSearchField) || 'all');
    this.page.set(1);
    this.load();
  }
